...
uint8_t motor2_init_state = INIT_INCOMPLETE;
int16_t motor2_last_ecd ;
int16_t MOTOR2_LAPS ;
float MOTOR2_ABSCISSA ;
int16_t motor2_power_up_ecd ;

uint8_t motor3_init_state = INIT_INCOMPLETE;
int16_t motor3_last_ecd ;
int16_t MOTOR3_LAPS ;
float MOTOR3_ABSCISSA ;
int16_t motor3_power_up_ecd ;

uint8_t motor4_init_state = INIT_INCOMPLETE;
int16_t motor4_last_ecd ;
int16_t MOTOR4_LAPS ;
float MOTOR4_ABSCISSA ;
int16_t motor4_power_up_ecd ;

uint8_t motor5_init_state = INIT_INCOMPLETE;
int16_t motor5_last_ecd ;
int16_t MOTOR5_LAPS ;
float MOTOR5_ABSCISSA ;
int16_t motor5_power_up_ecd ;

uint8_t motor6_init_state = INIT_INCOMPLETE;
int16_t motor6_last_ecd ;
int16_t MOTOR6_LAPS ;
float MOTOR6_ABSCISSA ;
int16_t motor6_power_up_ecd ;

uint8_t motor7_init_state = INIT_INCOMPLETE;
int16_t motor7_last_ecd ;
int16_t MOTOR7_LAPS ;
float MOTOR7_ABSCISSA ;
int16_t motor7_power_up_ecd ;
