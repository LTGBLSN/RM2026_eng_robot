...
osThreadId follow_arm_comHandle;
...
void follow_arm_compute_TASK(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of follow_arm_com */
  osThreadDef(follow_arm_com, follow_arm_compute_TASK, osPriorityIdle, 0, 512);
  follow_arm_comHandle = osThreadCreate(osThread(follow_arm_com), NULL);
...
/* USER CODE BEGIN Header_follow_arm_compute_TASK */
/**
* @brief Function implementing the follow_arm_com thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_follow_arm_compute_TASK */
__weak void follow_arm_compute_TASK(void const * argument)
{
  /* USER CODE BEGIN follow_arm_compute_TASK */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END follow_arm_compute_TASK */
}
