...
struct dm_motor DM4310_01 ;
struct dm_motor DM4310_02 ;
struct dm_motor DM4310_03 ;
struct dm_motor DM4310_04 ;
struct dm_motor DM4340_05 ;
struct dm_motor DM4340_06 ;
struct dm_motor DM4340_07 ;



void dm_motor_init()
{
    memset(&DM4310_01, 0, sizeof(DM4310_01));//清零
    DM4310_01.motor_type = DM4310 ;
    DM4310_01.can_id = 0x01 ;
    DM4310_01.can_master_id = 0x11 ;
    DM4310_01.can_channel = CAN_CHANNEL_1 ;
    DM4310_01.give_tor = 0.0f ;

    memset(&DM4310_02, 0, sizeof(DM4310_02));//清零
    DM4310_02.motor_type = DM4310 ;
    DM4310_02.can_id = 0x02 ;
    DM4310_02.can_master_id = 0x12 ;
    DM4310_02.can_channel = CAN_CHANNEL_1 ;
    DM4310_02.give_tor = 0.0f ;

    memset(&DM4310_03, 0, sizeof(DM4310_03));//清零
    DM4310_03.motor_type = DM4310 ;
    DM4310_03.can_id = 0x03 ;
    DM4310_03.can_master_id = 0x13 ;
    DM4310_03.can_channel = CAN_CHANNEL_1 ;
    DM4310_03.give_tor = 0.0f ;

    memset(&DM4310_04, 0, sizeof(DM4310_04));//清零
    DM4310_04.motor_type = DM4310 ;
    DM4310_04.can_id = 0x04 ;
    DM4310_04.can_master_id = 0x14 ;
    DM4310_04.can_channel = CAN_CHANNEL_1 ;
    DM4310_04.give_tor = 0.0f ;

    memset(&DM4340_05, 0, sizeof(DM4340_05));//清零
    DM4340_05.motor_type = DM4340 ;
    DM4340_05.can_id = 0x05 ;
    DM4340_05.can_master_id = 0x15 ;
    DM4340_05.can_channel = CAN_CHANNEL_2 ;
    DM4340_05.give_tor = 0.0f ;

    memset(&DM4340_06, 0, sizeof(DM4340_06));//清零
    DM4340_06.motor_type = DM4340 ;
    DM4340_06.can_id = 0x06 ;
    DM4340_06.can_master_id = 0x16 ;
    DM4340_06.can_channel = CAN_CHANNEL_2 ;
    DM4340_06.give_tor = 0.0f ;

    memset(&DM4340_07, 0, sizeof(DM4340_07));//清零
    DM4340_07.motor_type = DM4340 ;
    DM4340_07.can_id = 0x07 ;
    DM4340_07.can_master_id = 0x17 ;
    DM4340_07.can_channel = CAN_CHANNEL_2 ;
    DM4340_07.give_tor = 0.0f ;
