...
#define CHASSIS_4310_ID1_SPEED_PID_KI 0.0f
...
#define CHASSIS_4340_ID5_SPEED_PID_KP 10.0f
#define CHASSIS_4340_ID5_SPEED_PID_KI 0.1f
#define CHASSIS_4340_ID5_SPEED_PID_KD 0.0f

#define CHASSIS_4340_ID6_SPEED_PID_KP 10.0f
#define CHASSIS_4340_ID6_SPEED_PID_KI 0.1f
#define CHASSIS_4340_ID6_SPEED_PID_KD 0.0f


#define CHASSIS_4340_ID7_SPEED_PID_KP 10.0f
#define CHASSIS_4340_ID7_SPEED_PID_KI 0.1f
...
#define CHASSIS_4340_ANGLE_PID_OUT_MAX 4.0f
#define CHASSIS_4340_ANGLE_PID_KI_MAX 0.0f

#define CHASSIS_4310_ID1_ANGLE_PID_KP 4.0f
#define CHASSIS_4310_ID1_ANGLE_PID_KI 0.0f
#define CHASSIS_4310_ID1_ANGLE_PID_KD 0.0f

#define CHASSIS_4310_ID2_ANGLE_PID_KP 2.0f
#define CHASSIS_4310_ID2_ANGLE_PID_KI 0.0f
#define CHASSIS_4310_ID2_ANGLE_PID_KD 0.0f

#define CHASSIS_4310_ID3_ANGLE_PID_KP 2.0f
#define CHASSIS_4310_ID3_ANGLE_PID_KI 0.0f
#define CHASSIS_4310_ID3_ANGLE_PID_KD 0.0f

#define CHASSIS_4310_ID4_ANGLE_PID_KP 2.0f
#define CHASSIS_4310_ID4_ANGLE_PID_KI 0.0f
#define CHASSIS_4310_ID4_ANGLE_PID_KD 0.0f

#define CHASSIS_4340_ID5_ANGLE_PID_KP 10.0f
#define CHASSIS_4340_ID5_ANGLE_PID_KI 0.0f
#define CHASSIS_4340_ID5_ANGLE_PID_KD 0.0f

#define CHASSIS_4340_ID6_ANGLE_PID_KP 10.0f
#define CHASSIS_4340_ID6_ANGLE_PID_KI 0.0f
#define CHASSIS_4340_ID6_ANGLE_PID_KD 0.0f

#define CHASSIS_4340_ID7_ANGLE_PID_KP 10.0f
#define CHASSIS_4340_ID7_ANGLE_PID_KI 0.0f
#define CHASSIS_4340_ID7_ANGLE_PID_KD 0.0f



#define MOTOR1_MAX_ANGLE  0.00f
#define MOTOR1_MIN_ANGLE (-2.3f)

#define MOTOR2_MAX_ANGLE 4.00f
#define MOTOR2_MIN_ANGLE (-4.00f)

#define MOTOR3_MAX_ANGLE 1.78f
#define MOTOR3_MIN_ANGLE (-1.78f)

#define MOTOR4_MAX_ANGLE 1.47f
#define MOTOR4_MIN_ANGLE (-2.00f)
...
#define CLAMP_CLOSE_ANGLE (-0.21f)
#define CLAMP_OPEN_ANGLE (-2.0f)
